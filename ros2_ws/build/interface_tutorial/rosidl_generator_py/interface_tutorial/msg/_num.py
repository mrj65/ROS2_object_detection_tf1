...
class Metaclass_Num(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('interface_tutorial')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'interface_tutorial.msg.Num')
            logger.debug(
    ...
    def numb(self, value):
        if __debug__:
            assert \
                ...
                "The 'numb' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'numb' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._numb = value

...
#include "interface_tutorial/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_tutorial::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_tutorial::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_tutorial::msg::Num *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_interface_tutorial
const rosidl_message_type_support_t *
get_message_type_support_handle<interface_tutorial::msg::Num>()
{
  return &interface_tutorial::msg::typesupport_fastrtps_cpp::_Num__handle;
}

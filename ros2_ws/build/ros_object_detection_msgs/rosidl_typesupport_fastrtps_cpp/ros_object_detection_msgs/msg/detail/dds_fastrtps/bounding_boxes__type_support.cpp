...
#include "ros_object_detection_msgs/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_object_detection_msgs::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_object_detection_msgs::msg::BoundingBox &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.data[i],
        cdr);
    }
  }
  ...
  ros_object_detection_msgs::msg::BoundingBoxes & ros_message)
{
  // Member: data
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
  ...
  if (is_plain) {
    ...
    using DataType = ros_object_detection_msgs::msg::BoundingBoxes;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_object_detection_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_object_detection_msgs::msg::BoundingBoxes *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ros_object_detection_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<ros_object_detection_msgs::msg::BoundingBoxes>()
{
  return &ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}

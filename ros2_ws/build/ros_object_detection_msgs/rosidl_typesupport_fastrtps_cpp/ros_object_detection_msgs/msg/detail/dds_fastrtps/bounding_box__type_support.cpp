...
#include "ros_object_detection_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_object_detection_msgs::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_object_detection_msgs::msg::BoundingBox & ros_message)
{
  // Member: xmin
  cdr >> ros_message.xmin;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_object_detection_msgs::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_object_detection_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_object_detection_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_object_detection_msgs, msg, BoundingBox)() {
  return &ros_object_detection_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}

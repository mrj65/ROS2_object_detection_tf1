...
class Metaclass_BoundingBoxes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ros_object_detection_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ros_object_detection_msgs.msg.BoundingBoxes')
            logger.debug(
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        'data': 'sequence<ros_object_detection_msgs/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_object_detection_msgs', 'msg'], 'BoundingBox')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'BoundingBox'"
        self._data = value
